...
### 1. Завершение VK и Яндекс авторизации (2-3 дня)

**Что нужно сделать:**
1. Развернуть Firebase Functions
2. Получить и настроить API ключи
3. Протестировать OAuth flow
4. Добавить обработку ошибок

**Файлы для изменения:**
- `functions/src/index.ts` - проверить логику
- `lib/screens/auth_screen.dart` - обработка deep links
- `lib/services/firebase_service.dart` - улучшить error handling

### 2. Добавить offline поддержку (3-4 дня)
...
### 4. Улучшения производительности (2 дня)
